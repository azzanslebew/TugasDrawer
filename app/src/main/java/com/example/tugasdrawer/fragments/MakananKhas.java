...
public class MakananKhas extends Fragment implements AdapterList.ItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataList.add(new DataItem("Lentog Tanjung", "4.9", R.drawable.lentog_tanjung));
        ...
        dataList.add(new DataItem("Pecel Pakis Colo", "4.7", R.drawable.pecel_pakis));
        dataList.add(new DataItem("Sate Kerbau", "4.8", R.drawable.sate_kerbau));
        dataList.add(new DataItem("Jenang", "4.9", R.drawable.jenang));
